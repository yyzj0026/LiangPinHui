package com.winds.liangpinhui.jsonUtils;

import com.winds.liangpinhui.models.goodDetail_model.Brand;
import com.winds.liangpinhui.models.goodDetail_model.From_user;
    ...
    public GoodDetail getJsonStr(String jsonStr){
        ...
        try {
            ...
            for(int i=0;i<detail_params.length();i++){   //detail_params里内容，商品概述
                ...
                detail_params_map.put(key,value);
            }
